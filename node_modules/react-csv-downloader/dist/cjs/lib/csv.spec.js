...
describe('CSV Creator', () => {
    ...
    describe('Nulls and undefineds', () => {
        it('should convert null to empty field', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield csv_1.default({ columns: columnSet1, datas: dataSet6 });
            chai_1.expect(result).to.equal(`cell1${newLine}row1${newLine}${newLine}row3`);
        }));
        it('should convert null to empty field', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield csv_1.default({ columns: columnSet1, datas: dataSet7 });
            chai_1.expect(result).to.equal(`cell1${newLine}row1${newLine}${newLine}row3`);
        }));
    });
});
